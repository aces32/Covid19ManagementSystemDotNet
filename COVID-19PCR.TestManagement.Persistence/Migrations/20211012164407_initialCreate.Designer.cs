...
namespace COVID_19PCR.TestManagement.Persistence.Migrations
{
    ...
    [Migration("20211012164407_initialCreate")]
            ...
            modelBuilder.Entity("COVID_19PCR.TestManagement.Domain.Entites.Individual", b =>
                {
                    ...
                    b.HasOne("COVID_19PCR.TestManagement.Domain.Entites.IndividualLab", "IndividualLab")
                        .WithOne("Individual")
                        .HasForeignKey("COVID_19PCR.TestManagement.Domain.Entites.Individual", "IndividualLabId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
